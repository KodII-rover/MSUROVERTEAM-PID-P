...
- Открытая простая лицензия (Russian Open License) (see [GENERAL_LICENSE-RF-RC.md](https://github.com/KodII-rover/MSUROVERTEAM-PID-P/blob/master/GENERAL_LICENSE-RF-PID-P.md))
